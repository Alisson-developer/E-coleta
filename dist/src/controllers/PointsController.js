...
var PointsController = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        parsedItems = String(items).split(',').map(function (item) { return Number(item.trim()); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        point = _a.sent();
                        if (!point) {
                            return [2 /*return*/, response.status(404).json({ error: 'Point not found!' })];
                        }
    ...
    PointsController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, whatsapp, latitude, longitude, city, uf, items, transaction, point, insertedIds, point_id, pointsItems;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        pointsItems = items.map(function (item_id) {
                            return {
                                item_id: item_id,
                                point_id: point_id
                            };
                        });
                        return [4 /*yield*/, transaction('points_items').insert(pointsItems)];
                    case 3:
                        _b.sent();
